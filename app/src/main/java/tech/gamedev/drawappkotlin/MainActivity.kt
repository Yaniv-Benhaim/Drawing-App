package tech.gamedev.drawappkotlin
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Accessing the LinearLayout like an array
        mImageBtnCurrentPaint = ll_paint_colors[1] as ImageButton
    ...
    private fun showBrushSizeDialog(){
        ...
        smallBtn.setOnClickListener {
            drawing_view.setSizeForBrush(2.toFloat())
            brushDialog.dismiss()
        }
